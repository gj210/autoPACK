...
wrkDirGeom = wrkDir+"/autoFillRecipeScripts/2DCylinderSphereFill/"
#DEJAVU COLORS
modelFormat = "dae"
...
afviewer = AFViewer(ViewerType=ViewerType,helper=helper)#long ?
...
#    bbox = afviewer.helper.box("histoVolBB",center=[0.,0.,0.],size=[1000.,1000.,6.], parent=arr1)[0] #remember x and z will swap for left-handed hosts or files
#    else :
#   bbox = afviewer.helper.box("histoVolBB",center=[0.,0.,0.],size=[1000.,1000.,6.])[0] #remember x and z will swap for left-handed hosts or files
...
#    h1.setExteriorRecipe(rECM)
    o1 = Organelle("exteriorOrganelle1",None, None, None,isOrthogonalBoudingBox=1)
...
resultfilename = h1.resultfile =wrkDir+os.sep+"autoFillRecipeScripts/2DcylinderSphereFill/results/CylSpherefillResult.afr"
