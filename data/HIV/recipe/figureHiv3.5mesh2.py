...
rMatrix = {"Capside":Recipe(),"Nucleus":Recipe()}
rCyto = Recipe()
...
#        rSurf["Nucleus"].addIngredient(cyl26Ingr1)
    ...
    rSurf["Capside"].addIngredient(nc)#should be nucleus compartiment 2
...
for n in name :
    if n == "Nucleus" :
        f=wrkDirOrga+'/'+n#"http://grahamj.com/www/autofill/autoFillData/HIV/HIV_0_0_1/HIV_OrganelleGeoms/HIV_1_1_NucleocapsidHostMesh.c4d"
    else :
        f=wrkDirOrga+'/'+n
