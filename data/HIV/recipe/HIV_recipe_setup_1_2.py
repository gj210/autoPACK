...
#execfile("/Users/user/DEV/AutoFill/HIV/figureHiv3.5mesh.py")
#execfile("/Users/user/DEV/Autofill_svn_test/autofill/trunk/AutoFillClean/autoFillRecipeScripts/HIV/figureHiv3.5mesh2.py")
...
if AutoFill.helper.host == 'c4d' or AutoFill.helper.host.find("blender") != -1 or AutoFill.helper.host == 'dejavu':
    modelFormat = "dae"
...
exec(open(setupfile,"r").read(),globals(),{"wrkDir2":sphdirGC,"tempRecipe":rMatrix["Envelope"],"httpwrkDir":httpwrkDirGC})
...
for n in name :
    ...
    if n == "NucleoCapsid" :#and helper.host == "c4d":
        ...
        o1 = Organelle(n,None, None, None,
                       filename=f,object_name = "HIV_Envelope_1.0",
                       object_filename = meshDir+"HIV_Envelope_1.0."+hext)
