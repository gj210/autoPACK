...
Name: '2DSpheresGradients_setup_recipe.py'
...
#    d["400_n25"] =  {"rad":25,"dic":    {"packingPriority":0,"nMol":60,"color":None}}
    ...
    d["y400_n25"] = {"rad":12,"molarity":1.0,"dic":    {"packingPriority":0,"nbMol":64, "color": rgbPurple}}
#    d["a400_n25"] = {"rad":25,"dic":    {"packingPriority":0,"nMol":16,"color":None}}
#    d["b400_n25"] = {"rad":25,"dic":    {"packingPriority":0,"nMol":16,"color":None}}
...
#    lingr["y400_n25"].packingMode=packingmode
    lingr["y400_n25"].gradient = grname3
    lingr["y400_n25"].packingMode=packingmode
...
# viewer setup
#===============================================================================
afviewer = AutopackViewer(ViewerType=helper.host,helper=helper)#long ?
...
h1.name="Test_Spheres2Dgradients"
...
if bbox is None : bbox = afviewer.helper.box("histoVolBB", cornerPoints=[[-500.,-500,-0.5],[500,500,0.5]])#cornerPoints=h1.boundingBox)
...
if grname is not None :
    ...
    h1.setGradient(name=grname3,mode="radial",weight_mode="linear",pick_mode="sub",direction=[500.,500.,0.0],radius=1400.0)
...
h1.runTimeDisplay = 2 #interactive display
...
#===============================================================================
try :
    AFGui.Set("Test_Spheres2Dgradients",helper=afviewer.helper,afviewer=afviewer,histoVol=h1,bbox=bbox)
except:
    print ("no GUI")
print (7,time()-tStart)
tStart = time()
