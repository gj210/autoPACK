...
#
# This file "Gui.py" is part of autoPACK, cellPACK.
#
...
class AutoPACKCommand(MVCommand):
    ...
    def doit(self, *args, **kw):
        ...
        if self.apgui is None :
            self.apgui =Gui.AutoPackGui(title="AFGui",master=vi)
            self.apgui.setup(rep="autopack",host="dejavutk",vi=vi)
        self.apgui.display()
...
#self.browseCommands('autoPackpmvCommands',package="autopack.plugin",commands=['autoPACK'],topCommand=0)